...
if ok:
 ...
 if rc2==0 and (root/'strict-bin').exists():
  ...
  if rr2==0 or 'Set elements of type' not in ro2:
   ok=False; log.append('strict JS runtime did not preserve Set<any> fence')
 elif rc2!=0 and 'Set elements of type' not in out2:
  ok=False; log.append('strict JS compile failed for an unrelated reason')
prime=[]
if ok:
